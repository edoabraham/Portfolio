...
void ColorPicker::Init() {
	...
	// Preset list.
	this->PresetColorList_.push_back(QColor(21, 86, 140)); // [0] Blue
	this->PresetColorList_.push_back(QColor(169, 33, 42)); // [1] Dark Red
	this->PresetColorList_.push_back(QColor(37, 181, 59)); // [2] Green
	this->PresetColorList_.push_back(QColor(116, 142, 4)); // [3] Dark Yellow
	this->PresetColorList_.push_back(QColor(145, 85, 18)); // [4] Dark Orange
}
