...
QMAKE    = /usr/bin/qmake
SimulationPlotGUI.xcodeproj/project.pbxproj: SimulationPlotGUI.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o SimulationPlotGUI.xcodeproj/project.pbxproj SimulationPlotGUI.pro
